...
function Main() {
  window.document.title = 'SirPaulGH — Main';
  ...
  useEffect(() => {
    switch (selectedKeys) {
      case '1': {
        window.document.title = 'SirPaulGH — Dashboard';
        break;
      }
      case '2': {
        window.document.title = 'SirPaulGH — Users';
        break;
      }
      case '3': {
        window.document.title = 'SirPaulGH — Hotel Rooms';
        break;
      }
      case '4': {
        window.document.title = 'SirPaulGH — Booking Orders';
        break;
      }
      case '5': {
        window.document.title = 'SirPaulGH — Profile';
        break;
      }
      case '6': {
        window.document.title = 'SirPaulGH — Logout';
        break;
      }
      default: {
        window.document.title = 'SirPaulGH — Dashboard';
    ...
    <Layout className='w-full h-screen'>
      ...
      <Layout>
        ...
        <Footer className='text-center font-text-font font-medium '>
          ©2024 SirPaulGuestHouse — Developed By
          {' '}
          <a
            className='text-color-primary hover:text-color-secondary'
            href='https://mrmaroga.co.za'
            target='_blank'
            rel='noreferrer'
          >
            Mr Maroga
