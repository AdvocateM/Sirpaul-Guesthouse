...
exports.loginUser = async (req, res) => {
  ...
  try {
    ...
    // Check if loginType is "admin" and user has appropriate role
    ...
    // Update user status and last updated time
    ...
    // Respond with user data and JWT access token
    loginResponse(res, updatedUser);
  } catch (error) {
